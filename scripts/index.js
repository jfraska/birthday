...
const slideshowItems = document.querySelectorAll('.message-item');
    ...
    function showSlideshow() {
      ...
      function showSlide() {
        if (slideshowItems.length > 0) {
          ...
          // Update slideIndex and stop when reaching the last item
          slideIndex++;
          if (slideIndex < slideshowItems.length) {
            setTimeout(showSlide, 7000); // Ganti slide setiap 3 detik
          }
        }
      }
      showSlide();
